    ...
    <>
      ...
      <div className="pg-group">
        ...
        <div className="pg-canvas">
          <xds-button kind="tertiary" onClick={() => open(confirmRef)}>Confirmação</xds-button>
          <xds-button kind="danger"   onClick={() => open(dangerRef)}>Destrutivo</xds-button>
          <xds-button kind="primary"  onClick={() => open(successRef)}>Sucesso</xds-button>
        </div>
      </div>
      ...
      <div className="pg-group">
        ...
        <div className="pg-canvas">
          <xds-button size="sm" kind="tertiary" onClick={() => open(sizeXsRef)}>xs</xds-button>
          <xds-button size="sm" kind="tertiary" onClick={() => open(sizeSmRef)}>sm</xds-button>
          <xds-button size="sm" kind="tertiary" onClick={() => open(sizeMdRef)}>md</xds-button>
          <xds-button size="sm" kind="tertiary" onClick={() => open(sizeLgRef)}>lg</xds-button>
        </div>
      </div>
      ...
      <div className="pg-group">
        ...
        <div className="pg-canvas">
          <xds-button kind="secondary" onClick={() => open(labelRef)}>Com label</xds-button>
          <xds-button kind="secondary" onClick={() => open(scrollRef)}>Com scroll</xds-button>
          <xds-button kind="secondary" onClick={() => open(noFooterRef)}>Sem footer</xds-button>
        </div>
      </div>
