...
export default function ButtonPage() {
  ...
  return (
    <>
      ...
      <div className="pg-group">
        <div className="pg-group__label">Loading — toggle interativo</div>
        <div className="pg-canvas" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '1rem' }}>
          <xds-button kind="tertiary" size="sm" onClick={() => setLoading(v => !v)}>
            {loading ? 'Desativar loading' : 'Ativar loading'}
          </xds-button>
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
            <xds-button kind="primary" loading={loading || undefined}>
              {loading ? 'Salvando...' : 'Salvar'}
            </xds-button>
            <xds-button kind="secondary" loading={loading || undefined}>
              {loading ? 'Enviando...' : 'Enviar'}
            </xds-button>
            <xds-button kind="danger" icon-position="left" loading={loading || undefined}>
      ...
      <div className="pg-group">
        ...
        <div className="pg-canvas">
          <form
            ...
            onSubmit={e => { e.preventDefault(); alert('submit disparado!'); }}
            onReset={() => alert('reset disparado!')}
          >
